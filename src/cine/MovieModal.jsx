...
const MovieModal = ({ selectedMovie, onClose, onAddToCart }) => {
  const { title, cover, rating, genre, price, description } = selectedMovie;
          ...
          <div className="p-5 lg:p-11">
            ...
            <div className="grid lg:grid-cols-2 gap-2">
              <a
                ...
                href="#"
                onClick={(selectedMovie) => onAddToCart(selectedMovie)}
              >
